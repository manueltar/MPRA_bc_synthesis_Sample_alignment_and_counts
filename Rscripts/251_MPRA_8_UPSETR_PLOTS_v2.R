...
UpSetR_like_E_Plus_ASE = function(option_list)
{
  ...
  for(iteration_value_arrays in 1:length(value_arrays))
  {
    ...
    path7<-paste(out,'UpSetR_like_plots','/','E_Plus_ASE','/','WITH_CTRLS','/', sep='')
    ...
    path8<-paste(out,'UpSetR_like_plots','/','E_Plus_ASE','/','WITHOUT_CTRLS','/', sep='')
...
UpSetR_like_enhancer = function(option_list)
{
  ...
  path6<-paste(out,'UpSetR_like_plots','/','enhancer','/', sep='')
  ...
  for(iteration_value_arrays in 1:length(value_arrays))
  {
    ...
    path7<-paste(out,'UpSetR_like_plots','/','enhancer','/','WITH_CTRLS','/', sep='')
    ...
    path8<-paste(out,'UpSetR_like_plots','/','enhancer','/','WITHOUT_CTRLS','/', sep='')
